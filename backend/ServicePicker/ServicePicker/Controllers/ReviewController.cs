namespace ServicePicker.Controllers
{
    ...
    public class ReviewController : ControllerBase
    {
        ...
        public ReviewController(ILogger<ReviewController> logger, IReviewService reviewService, IAccountService accountService)
        {
            this.logger = logger;
        ...
        {
            var result = reviewService.GetServiceReviews(productId);
